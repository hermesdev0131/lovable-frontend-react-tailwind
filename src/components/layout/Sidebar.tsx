...
const Sidebar = () => {
  ...
  return (
    <div 
      className={cn(
        "fixed left-0 top-0 h-screen bg-sidebar border-r border-border transition-all duration-300 z-30", 
        ...
        <div className={cn("p-6 flex items-center", isExpanded ? "justify-between" : "justify-center")}>
          ...
          >
            <svg 
              ...
              className={cn("transform transition-transform", isExpanded ? "" : "rotate-180")}
            >
              <path 
