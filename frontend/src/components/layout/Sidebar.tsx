...
const Sidebar: React.FC<SidebarProps> = ({ isExpanded, onToggle, children }) => {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      {/* Mobile Sidebar */}
      <MobileSidebar isOpen={isMobileSidebarOpen} onClose={handleToggleMobileSidebar} />
      
      <div className="flex-1 flex flex-col overflow-hidden">
        <Navbar onToggleSidebar={isMobile ? handleToggleMobileSidebar : onToggle} />
        <main className="flex-1 overflow-y-auto bg-background p-3 md:p-6 w-full">
          {children}
        </main>
      </div>
    </div>
